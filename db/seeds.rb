...
RaceDistance.find_or_create_by(distance: 10000, name: '10k')
RaceDistance.find_or_create_by(distance: 15000, name: '15k')
RaceDistance.find_or_create_by(distance: 20000, name: '20k')
RaceDistance.find_or_create_by(distance: 21097, name: 'Half Marathon')
RaceDistance.find_or_create_by(distance: 42195, name: 'Marathon')
RaceDistance.find_or_create_by(distance: 50000, name: '50k')
RaceDistance.find_or_create_by(distance: 80467, name: '50 miles')
RaceDistance.find_or_create_by(distance: 100000, name: '100k')
RaceDistance.find_or_create_by(distance: 160934, name: '100 miles')
