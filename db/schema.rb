...
ActiveRecord::Schema.define(version: 20170227095758) do
  ...
  create_table "activities", force: :cascade do |t|
    ...
    t.index ["athlete_id"], name: "index_activities_on_athlete_id", using: :btree
    t.index ["gear_id"], name: "index_activities_on_gear_id", using: :btree
    t.index ["workout_type_id"], name: "index_activities_on_workout_type_id", using: :btree
  end
  ...
  create_table "athletes", force: :cascade do |t|
    ...
    t.index ["state_id"], name: "index_athletes_on_state_id", using: :btree
    t.index ["username"], name: "index_athletes_on_username", using: :btree
  end
  ...
  create_table "best_effort_types", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_best_effort_types_on_name", using: :btree
  end

  create_table "best_efforts", id: :bigserial, force: :cascade do |t|
    ...
    t.datetime "created_at",          null: false
    t.datetime "updated_at",          null: false
    t.index ["activity_id"], name: "index_best_efforts_on_activity_id", using: :btree
    t.index ["athlete_id"], name: "index_best_efforts_on_athlete_id", using: :btree
    t.index ["best_effort_type_id"], name: "index_best_efforts_on_best_effort_type_id", using: :btree
  end
  ...
  create_table "gears", primary_key: "gear_id", id: :string, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["athlete_id"], name: "index_gears_on_athlete_id", using: :btree
  end
  ...
  create_table "race_distances", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_race_distances_on_name", using: :btree
  end
  ...
  create_table "races", force: :cascade do |t|
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["activity_id"], name: "index_races_on_activity_id", using: :btree
    t.index ["athlete_id"], name: "index_races_on_athlete_id", using: :btree
    t.index ["race_distance_id"], name: "index_races_on_race_distance_id", using: :btree
  end
  ...
  create_table "workout_types", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_workout_types_on_name", using: :btree
  end
