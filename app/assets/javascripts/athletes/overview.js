        ...
        success: function(data) {
            ...
            if (distances.length === 0) {
                ...
                distances.forEach(function(model) {
                    ...
                    table += '<th class="col-md-1 text-center badge-cell hidden-md-down">Type</th>';
                    table += '<th class="col-md-4">Activity</th>';
                    table += '<th class="col-md-1">Time</th>';
                    table += '<th class="col-md-1 hidden-xs-down">Pace</th>';
                    table += '<th class="col-md-2 hidden-lg-down">Gear</th>';
                    table += '<th class="col-md-1 text-center badge-cell hidden-md-down">Avg. HR</th>';
                    table += '<th class="col-md-1 text-center badge-cell hidden-md-down">Max HR</th>';
                    table += '</tr>';
                    table += '</thead>';
                    table += '<tbody>';
                    model['items'].forEach(function(item) {
                        ...
                        table += '<td class="text-center badge-cell hidden-md-down">';
                        ...
                        table += '<td class="hidden-xs-down">' + item["pace"] + '<small>' + item["pace_unit"] + '</small></td>';
                        table += '<td class="hidden-lg-down">' + item['gear_name'] + '</td>';
                        table += "<td class='text-center badge-cell hidden-md-down'>";
