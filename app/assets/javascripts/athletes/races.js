...
function createRaceDatatableHeader() {
    ...
    header += '<th class="col-md-1 hidden-md-down">Elevation</th>';
    header += '<th class="col-md-1 hidden-md-down">Cadence</th>';
...
function createRaceDatatableRow(item) {
    ...
    row += '<td class=" hidden-md-down">' + item["elevation"] + '<small> ' + item["elevation_unit"] + '</small></td>';
    row += '<td class=" hidden-md-down">' + item["cadence"] + '</td>';
