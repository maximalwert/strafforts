function loadRacesView(distanceText) {
    ...
    var constructDataTableHtml = function (races) {
        ...
        if (races === undefined) {
            ...
            table += '<th class="col-md-1 hide-in-small-screen">Elevation</th>';
            table += '<th class="col-md-1 hide-in-small-screen">Cadence</th>';
            ...
            races.forEach(function(item) {
                ...
                table += '<td class="hide-in-small-screen">' + item["elevation"] + '<small> ' + item["elevation_unit"] + '</small></td>';
                table += '<td class="hide-in-small-screen">' + item["cadence"] + '</td>';
    ...
    var createView = function () {
        ...
        $.ajax({
            url: window.location.pathname + '/races/' + distance,
            dataType: 'json',
            async: false,
