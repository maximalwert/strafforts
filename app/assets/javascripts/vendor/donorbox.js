(function (w, d) {
    ...
    var buttonClass  = 'dbox-donation-button', frameID = 'donorbox_widget_frame', shouldOpenNewTab, disableScrolling,
    ...
    function toggleScrolling(disable) {
        disable && (disableScrolling = true)
        d.body.style.overflow = disableScrolling ? 'hidden' : 'initial';
    ...
    w.dw_open = function () {
        ...
        for(; i < len; i++)
            addEventListener(buttons[i], 'click', onBtnClick)
    };

    addEventListener(w, 'message', function (e) {
        if (typeof e.data == 'object' && e.data.from == 'dbox' && e.data.close === true) {
