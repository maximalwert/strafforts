...
RSpec.describe BestEffortsDecorator, type: :decorator do
  let(:expected_folder) { './spec/requests/expected'.freeze }

  let(:items) { BestEffort.find_all_by_athlete_id(9123806) }

  it 'should get the same amount of items after decorating' do
    # act.
    decorated_items = BestEffortsDecorator.decorate(items).object
  ...
  describe '.to_show_in_overview' do
    ...
    it 'should match expected' do
      ...
      # act.
      decorator = BestEffortsDecorator.decorate(items)
